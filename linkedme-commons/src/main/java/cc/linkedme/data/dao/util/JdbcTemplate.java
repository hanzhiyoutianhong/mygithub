...
public class JdbcTemplate extends JdbcAccessor {
    ...
    /**
     * convert jdbc:mysql://s4606a.eos.grid.sina.com.cn:4606/user_0?useUnicode=true&characterEncoding=UTF-8&autoReconnect=true&zeroDateTimeBehavior=round to
     * s4606a.eos.grid.sina.com.cn
     *
     * @param jdbcUrl
     * @return
     */
    ...
    public void setDataSourceSlaves(List<DataSource> dataSourceSlaves) {
        ...
        try {
            ...
            for (DataSource dataSourceSlave : this.dataSourceSlaves) {
                ...
                dataSourceSlavesSwitchers.add(new ResourceSwitcherSupport(MYSQL_RESOURCE_TYPE, subJdbcUrlSwitchName(c3p0DataSource.getJdbcUrl()), port));
    ...
    private Connection safeGetConnection(DataSource ds, boolean isWrite) throws CannotGetJdbcConnectionException {
        ...
        while (count-- > 0) {
            ...
            try {
                ...
                ApiLogger.info(new StringBuilder(64).append("get connection try count:").append((retryCount - count)).append(", ds=").append(((com.mchange.v2.c3p0.ComboPooledDataSource) ds).getJdbcUrl()) + ",time:" + (System.currentTimeMillis() - start));
                DataSourceUtils.releaseConnection(con, ds);
            }
        }
