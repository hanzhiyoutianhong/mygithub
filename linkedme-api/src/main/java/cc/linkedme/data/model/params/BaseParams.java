...
public class BaseParams {
    ...
    public BaseParams(long identity_id, String device_fingerprint_id, String sdk_version, int retry_times, String linkedme_key, long timestamp, String sign, boolean is_debug) {
