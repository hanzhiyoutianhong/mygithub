        ...
        new Thread() {
            ...
            public void run() {
                MailSender.sendHtmlMail("support@linkedme.cc", "hello,LinkedME, 来新用户了!",
                        String.format("新用户的邮箱:%s <br />新用户的电话:%s <br />请及时联系!", user.getEmail(), user.getPhoneNumber()));
                MailSender.sendHtmlMail(user.getEmail(), "LinkedME 注册成功",
                        String.format(
