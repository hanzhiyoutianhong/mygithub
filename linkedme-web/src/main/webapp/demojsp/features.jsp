...
<div id="lb" class="banner">
    ...
    <div style="float:right;margin-top:12px;top:0;">
        ...
        <script>
            ...
            linkedme.init("7e289a2484f4368dbafbd1e5c7d06903", {type: "test"}, null);
            var data = {};
            data.params = '{"control":"LinkedME","View":"https://www.linkedme.cc/iosdemo/features.jsp"}';
            data.type = "live";
...
<div class="char_center">
    <div class="char_row">
        ...
        <div class="char_content">
            ...
            LinkedME的深度链接机制的重要特性是跨平台，该特性主要体现在三个方面，第一，跨开发平台，支持Android，iOS，Hybrid
            App；第二，跨不同终端，支持Phone，Pad，Pc等等；第三，跨应用商店，不因应用商店下载，而丢掉链接，
