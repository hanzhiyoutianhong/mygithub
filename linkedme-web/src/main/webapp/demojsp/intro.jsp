...
<div class="div_intro_center"
     style="background-image:url(<%=basePath %>demoh5/Images/Intro/backgroundline.png);background-repeat:no-repeat;background-size:contain;background-position-y:100px;">
    <div class="intro_row">
    ...
    <div class="intro_row">
        <div class="intro_box">
            ...
            <div style="padding-left:65px">
                <p class="intro_default_font align-left"><img class="intro_key"
                                                              src="<%=basePath %>demoh5/Images/Intro/arrow.png"/>
                    App页面的唯一指标</p>
                <p class="intro_default_font align-left"><img class="intro_key"
                                                              src="<%=basePath %>demoh5/Images/Intro/arrow.png"/> 深度内容分享
                </p>
                <p class="intro_default_font align-left"><img class="intro_key"
                                                              src="<%=basePath %>demoh5/Images/Intro/arrow.png"/> App间互联
                </p>
                <p class="intro_default_font align-left"><img class="intro_key"
                                                              src="<%=basePath %>demoh5/Images/Intro/arrow.png"/>
                    Web与App间互通</p>
                <p class="intro_default_font align-left"><img class="intro_key"
                    ...
                    可视化数据分析中心</p>
                <p class="intro_default_font align-left"><img class="intro_key"
                                                              src="<%=basePath %>demoh5/Images/Intro/arrow.png"/> 精细化运营
                </p>
            </div>
