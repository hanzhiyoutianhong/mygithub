...
public class User {
    ...
    @POST
    @Produces({MediaType.APPLICATION_JSON})
    public String logout(@FormParam("email") String email,
                         @FormParam("last_logout_time") String last_logout_time,
                         @FormParam("token") String token) {
    ...
    @POST
    @Produces({MediaType.APPLICATION_JSON})
    public String change_password(@FormParam("email") String email,
                                  @FormParam("old_pwd") String old_pwd,
    ...
    @POST
    @Produces({MediaType.APPLICATION_JSON})
    public String set_password(@FormParam("email") String email,
                               @FormParam("new_pwd") String new_pwd,
                               @FormParam("token") String token) {
